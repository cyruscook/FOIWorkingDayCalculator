...
export const isNonWorkingDay = function isNonWorkingDay(date, easter) {
...
export const addWorkingDays = function addWorkingDays(date, days) {
	var easterYear = NaN;
	...
	for (var i = 0; i < days;) {
		...
		if (date.year !== easterYear) {
			...
			easter = new DateTime(...easterCalc(easterYear));
		}
